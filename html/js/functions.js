...
jQuery.fn.jmp3 = function(passedOptions){
	...
	return this.each(function(){
		...
		mp3html += 'width="' + options.width + '" height="42" ';
		...
		mp3html += '<embed wmode="transparent" width="' + options.width + '" height="42" ';
...
/**
 * jQuery.Select.dependiente by Julio Ponce
 * 
 **/
(function($) {
    $.fn.selectdependiente = function(depClass) {

         this.each(function(){  
         	$(this).change(function(){  
         		$(depClass).css("display","none");
            	$(".select-"+$(this).val()).css("display","block");  
         	});  
     	 });  
...
/**
 * jQuery.XML Autocomplete by Julio Ponce
 *
 **/
(function($) {
    $.fn.autocompleteXML = function(xmlfile, elemarr) {
		$(this).keydown(function(){
			...
			$.ajax({
				...
				success: function(xml) {
					...
					var data = [];  
					//process response  
					$(xml).find(elemarr).each(function(){
						data.push($(this).text());
					}); 
				   	//pass array to plugin 
					$("#"+input).autocomplete({
						source: data 
		  			});
		  		}
